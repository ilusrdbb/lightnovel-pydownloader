...
二手转载站（如哔哩轻小说）、国轻等站点不会适配，相关请求适配的issue会直接关闭  
...
| syosetu | syosetu | 纯自用于机翻站，需挂代理，账号注册问题自行解决，仅支持cookie登录从收藏中爬取，建议开启convert_txt |
...
| convert_txt_chapter |            是否同时导出txt且按照章节分割txt             |       true        |
